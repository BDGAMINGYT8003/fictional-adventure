...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('gonewild')
        .setDescription('Delivers a random NSFW gonewild image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/gonewild selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Gonewild Image', media, user: interaction.user })],
            components: [mediaRow('gonewild', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
