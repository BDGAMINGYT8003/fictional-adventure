...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('petgirls')
        .setDescription('Delivers a random NSFW petgirls image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/petgirls selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Petgirls Image', media, user: interaction.user })],
            components: [mediaRow('petgirls', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
