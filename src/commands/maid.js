...
module.exports = {
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/maid selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Maid Image', media, user: interaction.user })],
            components: [mediaRow('maid', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
