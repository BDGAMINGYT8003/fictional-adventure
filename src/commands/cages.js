...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('cages')
        .setDescription('Delivers a random NSFW cages image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/cages selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Cages Image', media, user: interaction.user })],
            components: [mediaRow('cages', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
