...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('4k')
        .setDescription('Delivers a random NSFW 4k image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/4k selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW 4k Image', media, user: interaction.user })],
            components: [mediaRow('4k', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
