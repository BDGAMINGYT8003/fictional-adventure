...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('buttplug')
        .setDescription('Delivers a random NSFW buttplug image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/buttplug selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Buttplug Image', media, user: interaction.user })],
            components: [mediaRow('buttplug', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
