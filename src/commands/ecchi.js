...
module.exports = {
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/ecchi selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Ecchi Image', media, user: interaction.user })],
            components: [mediaRow('ecchi', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
