...
module.exports = {
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/ero selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Ero Image', media, user: interaction.user })],
            components: [mediaRow('ero', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
