...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('cum')
        .setDescription('Delivers a random NSFW cum image/GIF')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/cum selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Cum Image', media, user: interaction.user })],
            components: [mediaRow('cum', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
