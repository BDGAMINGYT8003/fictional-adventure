...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('tentacle')
        .setDescription('Delivers a random NSFW tentacle image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/tentacle selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Tentacle Image', media, user: interaction.user })],
            components: [mediaRow('tentacle', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
