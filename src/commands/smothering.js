...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('smothering')
        .setDescription('Delivers a random NSFW smothering image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/smothering selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Smothering Image', media, user: interaction.user })],
            components: [mediaRow('smothering', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
