...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('socks')
        .setDescription('Delivers a random NSFW socks image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/socks selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Socks Image', media, user: interaction.user })],
            components: [mediaRow('socks', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
