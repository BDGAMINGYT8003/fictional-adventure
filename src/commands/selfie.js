...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('selfie')
        .setDescription('Delivers a random NSFW selfie image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/selfie selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Selfie Image', media, user: interaction.user })],
            components: [mediaRow('selfie', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
