...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('breeding')
        .setDescription('Delivers a random NSFW breeding image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/breeding selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Breeding Image', media, user: interaction.user })],
            components: [mediaRow('breeding', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
