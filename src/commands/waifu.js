...
module.exports = {
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/waifu selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Waifu Image', media, user: interaction.user })],
            components: [mediaRow('waifu', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
