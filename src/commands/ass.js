...
module.exports = {
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/ass selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Ass Image', media, user: interaction.user })],
            components: [mediaRow('ass', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
