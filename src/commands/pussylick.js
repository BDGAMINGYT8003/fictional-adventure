...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('pussylick')
        .setDescription('Delivers a random NSFW pussylick GIF')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/pussylick selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Pussylick Image', media, user: interaction.user })],
            components: [mediaRow('pussylick', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
