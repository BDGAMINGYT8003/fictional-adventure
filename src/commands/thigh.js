...
module.exports = {
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/thigh selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Thigh Image', media, user: interaction.user })],
            components: [mediaRow('thigh', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
