...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('kitsune')
        .setDescription('Delivers a random NSFW kitsune image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/kitsune selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Kitsune Image', media, user: interaction.user })],
            components: [mediaRow('kitsune', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
