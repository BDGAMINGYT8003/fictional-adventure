...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('legs')
        .setDescription('Delivers a random NSFW legs image')
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/legs selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Legs Image', media, user: interaction.user })],
            components: [mediaRow('legs', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
