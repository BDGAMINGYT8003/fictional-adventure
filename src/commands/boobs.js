...
module.exports = {
    ...
    async execute(interaction, context = {}) {
        ...
        logger.info('/boobs selected ' + sources.length + ' eligible source(s)');
        ...
        return interaction.editReply({
            embeds: [mediaEmbed({ title: 'NSFW Boobs Image', media, user: interaction.user })],
            components: [mediaRow('boobs', media.url, suffix)],
            files: file ? [file] : [],
        });
    },
};
