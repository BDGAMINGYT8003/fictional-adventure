...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('feet')
        .setDescription('Delivers a random Feet image'),
    async execute(interaction, isButton = false) {
        ...
        const endpoint = 'https://api.n-sfw.com/nsfw/feet';
        logInfo(`[/feet] Selected API Source: ABD (${endpoint})`);
